...
def _advisory_structure_company_targeting() -> str:
    return (
        ...
        "5. `## Top <Origin> RHQ Companies in Saudi Arabia` — a markdown "
        ...
        "FinTech Saudi …).\n"
        "6. `## Top Licensed <Origin> Companies in Saudi Arabia "
        ...
        "8. `## Target Companies and Investment Thesis Matrix` — the "
        ...
        "9. `## Recommendations to MISA` — 8–10 executable bullets. "
        ...
        "10. Close the document with this exact italic line:\n"
